...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddLigtherMetricService(this IServiceCollection services)
    {
        services.TryAddScoped<ILigtherMetricService, LigtherMetricService>();
        return services;
    }
